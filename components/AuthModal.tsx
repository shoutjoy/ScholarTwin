    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          {successMsg && (
             <div className="mb-4 p-3 bg-green-50 text-green-700 text-sm rounded-lg border border-green-200 font-medium">
                {successMsg}
             </div>
          )}

          {error && (
            <div className="mb-4 p-3 bg-red-50 text-red-600 text-sm rounded-lg border border-red-100 whitespace-pre-wrap">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {isLoginView ? 'Login' : 'Request Account'}
            </button>
          </form>
